    ...
    var messages = [
      {
        ...
        "body": $sce.trustAsHtml("<p>Hey Marge, </p><p>Check out this cool text.</p>"),
        "pic": "marge.png",
      ...
      },
      {
        ...
        "important": false,
        "body": $sce.trustAsHtml("<p>Hey Marge, </p><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>"),
        "pic": "marge.png",
        "email": "petraramsey@mail.com",
        "position": "Great Employee",
        "tag": "work",
      ...
      },
      {
        ...
        "body": $sce.trustAsHtml("<p>Hey Homer, Consectetur adipiscing elit</p><br>" +
      ...
      },
      {
        ...
        "body": $sce.trustAsHtml("<p>Hey Homer, </p><br><p>Consectetur adipiscing elit, Lorem ipsum dolor sit amet</p>"),
        "pic": "homer.png",
        "email": "barlowshort@mail.com",
        "position": "Graphical designer",
        "tag": "study",
      ...
      },
      {
        ...
        "body": $sce.trustAsHtml("<p>Hey Homer, </p><br><p>Integer eu nisl elit. Donec malesuada diam vitae tellus luctus tincidunt. Donec tempus blandit neque, rutrum egestas ipsum sagittis tempor. Curabitur volutpat ligula enim, nec vehicula purus molestie at. Sed a facilisis enim, nec molestie magna. Donec in augue non est viverra dapibus vel tempus risus. Nam porttitor purus sit amet hendrerit ullamcorper. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.</p>"),
        "pic": "homer.png",
        "email": "barlowshort@mail.com",
        "position": "Graphical designer",
        "tag": "work",
      ...
      },
      {
        ...
        "body": $sce.trustAsHtml("<p>Hey Lisa, </p><p>Aliquam eu facilisis eros, quis varius est.</p>" +
      ...
      },
      {
        ...
        "body": $sce.trustAsHtml("<p>Hello Lisa, </p><p>Lorem ipsum dolor sit amet!</p>" +
          "<p>Consectetur adipiscing elit. Aliquam sodales sem in nibh pellentesque, ac dignissim mi dapibus.</p>" +
      ...
      },
      {
        ...
        "subject": "Old product",
        "date": "2015-06-22T06:26:10",
        "body": $sce.trustAsHtml("<p>Hello Lisa, </p>" +
          "<p>Consectetur adipiscing elit. Aliquam sodales sem in nibh pellentesque, ac dignissim mi dapibus.</p>" +
          "<br>"+
      ...
      },
      {
        ...
        "body": $sce.trustAsHtml("<p>Hello Bart, </p><p>Aliquam sodales sem in nibh pellentesque</p>" +
      ...
      },
      {
        ...
        "body": $sce.trustAsHtml("<p>Hey Bart. </p><p>Lorem ipsum dolor sit amet!</p>" +
      ...
      },
      {
        ...
        "body": $sce.trustAsHtml("<p>Hey Abraham. </p><p>Aliquam sodales sem in nibh pellentesque</p>" +
      ...
      },
      {
        ...
        "body": $sce.trustAsHtml("<p>Hey Bart. </p>" +
          "<p>Cras tincidunt fermentum lectus, quis scelerisque lorem volutpat sed. Sed quis orci sed nisl sagittis viverra id at mauris. Nam venenatis mi nibh. Sed fringilla mattis vehic</p>"),
        "pic": "bart.png",
        "email": "lakeishaphillips@mail.com",
        "position": "Mobile Developer",
      ...
      },
      {
        ...
        "subject": "What next",
        "date": "2015-03-31T11:52:58",
        "body": $sce.trustAsHtml("<p>Hey Abraham. </p><p>Lorem ipsum dolor sit amet!</p>" +
